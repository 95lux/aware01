\title{Requirements Specification\\Embedded DSP Eurorack Synthesizer Module}
...
\section*{3. Objectives and Expected Benefits}
\begin{itemize}
...
\section*{4. Product Usage / Intended Use}
\begin{itemize}
...
\begin{itemize}
	...
	\item End-to-end audio latency suitable for live performance and not exceeding 20\,ms.
...
\section*{8. Project Phases and Milestones}
\begin{itemize}
	\item \textbf{M1:} Hardware assembly and power verification.
	\item \textbf{M2:} Functional hardware and peripheral testing.
	\item \textbf{M3:} Audio engine implementation.
	\item \textbf{M4:} DSP algorithm development.
	\item \textbf{M5:} Control interface implementation.
	\item \textbf{M6:} User interface integration and testing.
\end{itemize}

Further details are provided in the project plan.

\section*{9. Open Issues / Open Questions}
\begin{itemize}
