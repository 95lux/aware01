...
Output frequency was measured using the trigger frequency counter of a Tektronix TBS2000B oscilloscope at $\pm\SI{25}{ppm}$~\cite{TBS2000BSpecificationVerification_077153803_RevD}, corresponding to $\pm\SI{0.025}{Hz}$ at \SI{1}{kHz}, which is negligible relative to the deviations under investigation.
