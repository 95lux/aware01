...
To evaluate the audio signal path including analog frontends and AD/DA conversion, a sine was applied to the analog input at frequencies of \SI{100}{Hz} and \SI{1}{kHz}. 
All test signals were applied at \SI{10}{V_{pp}}, corresponding to the standard Eurorack signal level. 
