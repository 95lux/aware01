...
As detailed in the analog frontend design (Section~\ref{sec:input-attenuator-changes}), 
the input attenuator was revised to prevent ADC saturation on full-scale Eurorack signals. 
This section verifies the corrected design under measurement conditions.
