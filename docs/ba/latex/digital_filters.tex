...
A \ac{FIR} filter computes $y[n]$ as a weighted sum of the $M$ most recent input samples only:
...
An \ac{IIR} filter adds feedback terms, i.e. past output values, to the computation:
