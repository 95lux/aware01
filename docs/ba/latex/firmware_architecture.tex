...
It is a highly configurable device controlled entirely through a register interface, supporting sample rates from 8~kHz to 192~kHz with 
flexible clock generation, programmable gain stages, and configurable input/output routing \cite{texasinstrumentsTlv320aic3204Datasheet}.
...
\begin{listing}[h]
    ...
    \end{minted}
    \caption{TLV320AIC3204 driver -- clock divider configuration}
    \label{lst:codec_clk}
\end{listing}
