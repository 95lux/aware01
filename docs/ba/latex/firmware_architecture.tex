...
\noindent
All Gate and button inputs generate falling-edge interrupts at NVIC
priority~10, permitting the use of FreeRTOS API calls (specifically
\texttt{xTaskNotifyFromISR}) inside these handlers.

\texttt{GATE3\_IN} was relocated from PC9 to PC6 via a hardware bodge, as PC9 did not support EXTI interrupts simultaneously with the other assigned interrupt lines.
