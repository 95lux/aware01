...
However, a pin mapping error was introduced during schematic entry due to a mismatch between the simulation model and the actual SOT-23 package pinout of the BAT54S (See annotation in Schematic \ref{app:schematic} on Components D5, D6).
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.60\textwidth]{../images/hardware_design/simulation/schem_voct_simulation.pdf}
