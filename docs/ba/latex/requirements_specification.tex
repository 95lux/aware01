...
The system shall acquire audio signals via an external audio codec, process them
...
\begin{itemize}
    ...
    \item Two control voltage (CV) inputs, one V/Oct pitch input, and four gate
    inputs for Eurorack-compatible modulation
