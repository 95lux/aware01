...
Furthermore, all of the above are module products rather than custom hardware designs, while this work contributes a documented, open hardware platform that can be adapted and extended.
...
The design decisions made in this thesis are informed by these existing platforms, taking the custom hardware approach of Mutable Instruments as a reference while targeting a specific application not addressed by any of the above.