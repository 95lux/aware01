...
A \qty{1.27}{mm} pitch \ac{SWD} connector provides debugging and flashing, following the standard STDC14 ARM10 pinout \ref{stmicroelectronicsSTLINKV3SETDebuggerProgrammer}.
