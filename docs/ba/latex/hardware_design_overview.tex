...
A subsequent \textit{LM1117MP-3.3}\cite{Lm1117} \ac{LDO} regulator provides the \qty{3.3}{V} rail required by the MCU and codec. 
...
A \qty{1.27}{mm} pitch \ac{SWD} connector provides debugging and flashing.
