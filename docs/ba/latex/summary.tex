...
The resulting module, consisting of: hardware schematics, firmware, and DSP implementations, is published as open-source, offering a concrete, documented entry point into the Eurorack ecosystem outside the commercial supply chain.

Development will continue beyond the scope of this thesis; the published repository serves as a foundation for future contributors and a documented reference for embedded DSP in the Eurorack format.