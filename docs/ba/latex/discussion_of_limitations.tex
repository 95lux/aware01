...
In retrospect, a \texttt{float} accumulator would accumulate less than $0.012$ samples of error before the playhead wraps on a \qty{2.5}{\second} buffer, well below the resolution of the interpolator and fully sufficient for this use case.
...
Practically, the measured cutoff reaches into the audible low-frequency end; sub-bass content below \qty{30}{\Hz} is attenuated, though no impact was observed during in-system testing.