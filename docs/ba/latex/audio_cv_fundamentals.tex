...
While this produces very consonant fourths and fifths (musical interval of two tones), it results in out-of-tune thirds (another interval) \cite[p.~176]{wheelerScienceSound2014}.
...
In the case of a voltage-controlled oscillator (VCO) -- or any module that needs pitch control in a musical way -- , it is controlled by an external CV input: an increase of \qty{1}{V} corresponds to an increase of one octave in pitch. 
