...
void MX_TIM12_Init(void)
{
  ...
  htim12.Init.Prescaler = 50;
  htim12.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim12.Init.Period = 49998;
...
void MX_TIM17_Init(void)
{
  ...
  htim17.Init.Prescaler = 50;
  htim17.Init.CounterMode = TIM_COUNTERMODE_UP;
  htim17.Init.Period = 24999;
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* tim_pwmHandle)
{
  ...
  /* USER CODE END TIM15_MspInit 0 */
    ...
    /* TIM15 DMA Init */
    /* TIM15_CH1 Init */
    hdma_tim15_ch1.Instance = DMA1_Stream4;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PB13     ------> TIM1_CH1N
    */
    GPIO_InitStruct.Pin = FAD_LED3_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM1;
    HAL_GPIO_Init(FAD_LED3_OUT_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM12_MspPostInit 0 */
    ...
    PB15     ------> TIM12_CH2
    */
    GPIO_InitStruct.Pin = FAD_LED2_OUT_Pin|FAD_LED1_OUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
